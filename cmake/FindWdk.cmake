...
message(STATUS "ARCH: " ${MSVC_C_ARCHITECTURE_ID})
...
if(MSVC_C_ARCHITECTURE_ID MATCHES "^ARM")
    # disable stack protection on arm
    list(APPEND WDK_COMPILE_FLAGS "/GS-")
else()
    # __stdcall by default
...
elseif(MSVC_C_ARCHITECTURE_ID STREQUAL "ARM")
    list(APPEND WDK_COMPILE_DEFINITIONS "_ARM_")
    set(WDK_PLATFORM "arm")
elseif(MSVC_C_ARCHITECTURE_ID STREQUAL "ARM64")
    list(APPEND WDK_COMPILE_DEFINITIONS "_ARM64_")
